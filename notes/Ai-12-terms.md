# 12 Terms - You Will Need to Know!

> Each term below is tied to action.  
> Learn what it means, why it matters, and where it shows up while building a worker.  
 

## 1. Model
* What it means: the trained AI engine that reads your request and produces a response.
* Why it matters: diﬀerent models have diﬀerent strengths, costs, speed, and reliability.
* Where it shows up: when you choose what your worked thinks with. Examples include Claude, GPT, Gemini, and other model providers.
