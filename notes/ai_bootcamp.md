...
2. Advanced data structures (Dictionaries, sets, comprehensions).
3. File handling, APIs, and external libraries.
4. Error handling (Try/Except) and writing clean, PEP 8 code.
