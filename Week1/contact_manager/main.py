...
fresh_book = storage.load_contacts("Week1/contact_manager/contacts.json")

print(f"Reconstructed Book State:\n{fresh_book}")
    
# Final check: Make sure they are real objects, not raw strings or dicts
if isinstance(fresh_book, object):
    print(f"✅ Success! Verification object type: {type(fresh_book)}")
